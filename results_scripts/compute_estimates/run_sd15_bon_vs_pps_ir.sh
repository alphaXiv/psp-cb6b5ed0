...
RUN_LABEL="${RUN_LABEL:-drainprobe}"

RUN_TAG="$(date +%Y%m%d_%H%M%S)"
OUT_ROOT="${REPO_ROOT}/results/compute_estimates/rebuttal/sd15_bon_vs_pps_ir_${RUN_LABEL}_cudnn-${CUDNN_BENCHMARK}_${RUN_TAG}"
...
echo "[sd15-bon-vs-pps] output root: ${OUT_ROOT}"
...
echo "[sd15-bon-vs-pps] done"
echo "[sd15-bon-vs-pps] results: ${OUT_ROOT}"
