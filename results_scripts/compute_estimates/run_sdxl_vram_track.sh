...
OUT_ROOT="${REPO_ROOT}/results/compute_estimates/rebuttal/sdxl_vram_${RUN_LABEL}_cudnn-${CUDNN_BENCHMARK}_${RUN_TAG}"
...
echo "[sdxl-vram] output root: ${OUT_ROOT}"
...
echo "[sdxl-vram] done"
echo "[sdxl-vram] results: ${OUT_ROOT}"
