...
OUT_ROOT="${REPO_ROOT}/results/compute_estimates/rebuttal/sdxl_bon_n8_wallclock_${RUN_LABEL}_cudnn-${CUDNN_BENCHMARK}_${RUN_TAG}"
...
echo "[sdxl-bon-n8] output root: ${OUT_ROOT}"
...
echo "[sdxl-bon-n8] done"
echo "[sdxl-bon-n8] results: ${OUT_ROOT}"
