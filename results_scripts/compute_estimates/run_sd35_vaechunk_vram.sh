...
run_k() {
  local k="$1"
  local out_root="${REPO_ROOT}/results/compute_estimates/rebuttal/sd35_vaechunk_K${k}_${RUN_LABEL}_cudnn-${CUDNN_BENCHMARK}_${RUN_TAG}"
  echo "[sd35-vaechunk] K=${k} output: ${out_root}"
