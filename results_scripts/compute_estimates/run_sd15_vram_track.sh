...
OUT_ROOT="${REPO_ROOT}/results/compute_estimates/rebuttal/sd15_vram_${RUN_LABEL}_cudnn-${CUDNN_BENCHMARK}_${RUN_TAG}"
...
echo "[sd15-vram] output root: ${OUT_ROOT}"
...
echo "[sd15-vram] done"
echo "[sd15-vram] results: ${OUT_ROOT}"
