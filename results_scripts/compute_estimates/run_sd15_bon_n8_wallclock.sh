...
OUT_ROOT="${REPO_ROOT}/results/compute_estimates/rebuttal/sd15_bon_n8_wallclock_${RUN_LABEL}_cudnn-${CUDNN_BENCHMARK}_${RUN_TAG}"
...
echo "[sd15-bon-n8] output root: ${OUT_ROOT}"
...
echo "[sd15-bon-n8] done"
echo "[sd15-bon-n8] results: ${OUT_ROOT}"
