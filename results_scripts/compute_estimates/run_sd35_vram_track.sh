...
RUN_LABEL="${RUN_LABEL:-vram}"

RUN_TAG="$(date +%Y%m%d_%H%M%S)"
OUT_ROOT="${REPO_ROOT}/results/compute_estimates/rebuttal/sd35_vram_${RUN_LABEL}_cudnn-${CUDNN_BENCHMARK}_${RUN_TAG}"
...
echo "[sd35-vram] output root: ${OUT_ROOT}"
...
echo "[sd35-vram] done"
echo "[sd35-vram] results: ${OUT_ROOT}"
