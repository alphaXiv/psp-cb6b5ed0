...
OUT_ROOT="${REPO_ROOT}/results/compute_estimates/rebuttal/sdxl_bon_vs_pps_ir_${RUN_LABEL}_cudnn-${CUDNN_BENCHMARK}_${RUN_TAG}"
...
echo "[sdxl-bon-vs-pps] output root: ${OUT_ROOT}"
...
echo "[sdxl-bon-vs-pps] done"
echo "[sdxl-bon-vs-pps] results: ${OUT_ROOT}"
