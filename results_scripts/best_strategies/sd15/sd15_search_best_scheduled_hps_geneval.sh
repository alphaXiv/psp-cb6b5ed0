...
METRICS_CSV="results/reward_signal/sd15_reward_signal"
GENEVAL_CSV="results/reward_signal/sd15_reward_signal/sd15_geneval_sample_scores.csv"
OUTPUT_JSON="results/best_strategies/sd15/scheduled_hps_geneval.json"

echo "[sd15_search_best_scheduled_hps_geneval] Running command:"
