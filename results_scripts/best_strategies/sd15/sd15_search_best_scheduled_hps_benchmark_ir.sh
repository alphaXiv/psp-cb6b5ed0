...
METRICS_CSV="results/reward_signal/sd15_reward_signal/sd15_reward_signal_benchmark_gpu0_run01/metrics.csv"
GENEVAL_CSV="results/reward_signal/sd15_reward_signal/sd15_geneval_sample_scores.csv"
OUTPUT_JSON="results/best_strategies/sd15/scheduled_hps_benchmark_ir.json"

echo "[sd15_search_best_scheduled_hps_benchmark_ir] Running command:"
echo "python results_scripts/best_strategies/search_best_scheduled_strategies_single_dataset.py \\"
echo "  --model-label \"sd15\" \\"
