...
REWARDS_ROOT="results/reward_signal/sdxl_dpo_reward_signal"
GENEVAL_CSV="${REWARDS_ROOT}/sdxl_dpo_geneval_sample_scores.csv"
OUTPUT_DIR="results/dpo/sdxl"

echo "[sdxl_dpo_mt_scheduled_from_rewards] Running command:"
echo "python results_scripts/baselines/compute_mt_scheduled_from_rewards.py \\"
echo "  --model-label \"sdxl_dpo\" \\"
