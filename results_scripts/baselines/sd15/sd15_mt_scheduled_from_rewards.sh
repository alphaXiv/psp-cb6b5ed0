...
GENEVAL_CSV="${REWARDS_ROOT}/sd15_geneval_sample_scores.csv"
OUTPUT_DIR="results/baselines/sdv15"

echo "[sdv15_mt_scheduled_from_rewards] Running command:"
echo "python results_scripts/baselines/compute_mt_scheduled_from_rewards.py \\"
echo "  --model-label \"sdv15\" \\"
